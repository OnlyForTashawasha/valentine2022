...
const messages = [
  `
  Surprise Bubba!!!! Hehe I wanted to surprise u heaps todayy so I hope the game was a big surprise!! Hopefully there wasn't toooo many bugs ;-;`,
...
function init() {
  ...
  document.getElementById('present').addEventListener('click', () => {
    ...
    const a = new Audio('../assets/sound/letterTheme.mp3');
    a.loop = true;
    a.play();
  })
